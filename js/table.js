...
function areHeadersMatching(userHeaders, dbHeaders) {
  ...
  return userHeaders.split(',').map(h => h.trim()).join(',') === dbHeaders.join(',');
}
...
export function displayResults(matchingItems, partialMatches, noMatches) {
  const matchingContent = document.querySelector('#matchingItems .expandable-content .table-container');
  const partialContent = document.querySelector('#partialMatches .expandable-content .table-container');
  const noMatchContent = document.querySelector('#noMatches .expandable-content .table-container');
...
function toggleExpand() {
  console.log('Clicked on expandable title');
